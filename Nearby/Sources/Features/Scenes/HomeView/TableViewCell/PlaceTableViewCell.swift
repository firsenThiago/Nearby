...
class PlaceTableViewCell: UITableViewCell {
    ...
    private func setupConstraint() {
        NSLayoutConstraint.activate([
            ...
            titleLabel.leadingAnchor.constraint(equalTo: itemImageView.leadingAnchor, constant: 16),
            titleLabel.trailingAnchor.constraint(equalTo: containerView.trailingAnchor, constant: -8),
            
            descriptionLabel.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: 4),
            descriptionLabel.leadingAnchor.constraint(equalTo: itemImageView.leadingAnchor, constant: 16),
            descriptionLabel.trailingAnchor.constraint(equalTo: containerView.trailingAnchor, constant: -8),
            
            ticketIcon.topAnchor.constraint(equalTo: descriptionLabel.bottomAnchor, constant: 16),
    ...
    func configure(with place: Place) {
        ...
        ticketLabel.text = "\(place.cupons) cupons disponíveis"
    }
}
